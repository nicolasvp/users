...
INSERT INTO users (name, last_name, username, email, password, rol_id, created_at) VALUES('Johnathon','Savage','johnathon','Johnathon@mail.com', '123123', 1, NOW());
INSERT INTO users (name, last_name, username, email, password, rol_id, created_at) VALUES('Kien', 'Rosales','kien', 'Kien@mail.com', '123123', 2, NOW());
INSERT INTO users (name, last_name, username, email, password, rol_id, created_at) VALUES('Calvin', 'Buxton','calvin', 'Calvin@mail.com', '123123', 2, NOW());
INSERT INTO users (name, last_name, username, email, password, rol_id, created_at) VALUES('Ella', 'Hogg','ella','Ella@mail.com', '123123', 2, NOW());
INSERT INTO users (name, last_name, username, email, password, rol_id, created_at) VALUES('Stanislaw', 'Ward','stan', 'Stanislaw@mail.com', '123123', 2, NOW());
