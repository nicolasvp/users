...
public class LikesController {
	...
	public ResponseEntity<?> create(@Valid @RequestBody Likes like, BindingResult result) throws DatabaseAccessException {
	...
	public ResponseEntity<?> update(@Valid @RequestBody Likes like, BindingResult result, @PathVariable("id") Long id) throws NullRecordException, DatabaseAccessException {
